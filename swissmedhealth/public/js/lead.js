// This is a copy/paste of file ./apps/frappe/frappe/public/js/frappe/views/interaction.js
// with the following changes:
// - class name changed from frappe.views.InteractionComposer to frappe.views.KainotomoInteractionComposer
// - Renamed the field event_category to custom_category
//
...
frappe.views.InteractionComposer = class KainotomoInteractionComposer extends frappe.views.InteractionComposer {
    constructor(wrapper) {
        super(wrapper);
    }
	...
	get_event_categories() {
		...
		frappe.model.with_doctype("Event", () => {
			let categories = frappe.meta
				.get_docfield("Event", "custom_category")
				.options.split("\n");
...
// Add a button that will open the email modal form and customize the text
// of the email
