...
- Export apps to variable and build image
  ...
  docker build  --no-cache --build-arg=FRAPPE_PATH=https://github.com/frappe/frappe \
    ...
    --tag=phalouvas/swissmed-worker:15.27.4 \
    --file=images/azure/Containerfile .

  docker push phalouvas/swissmed-worker:15.27.4
  docker tag phalouvas/swissmed-worker:15.27.4 phalouvas/swissmed-worker:version-15
